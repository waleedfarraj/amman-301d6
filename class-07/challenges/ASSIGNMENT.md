...
1. Create a file in this new directory named `challenges-07.test.js`.
1. Copy and paste the **entire content** of today's [code challenge](challenges-07.test.js){:target="_blank"} into the new file.
