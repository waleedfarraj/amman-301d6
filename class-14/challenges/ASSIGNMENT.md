...
1. Create a file in this new directory named `challenges-14.test.js`.
1. Copy and paste the **entire content** of today's [code challenge](challenges-14.test.js){:target="_blank"} into the new file.
